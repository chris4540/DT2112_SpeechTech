...
\begin{problem}{3.2}
    ...
    For the application fit the "interface replacement" view, a chatbot called 
    ...
    the same functionality as this chatbot.

    % https://www.facebook.com/DrCareAi/photos/a.2123527274339622.1073741828.2076696632356020/2316047921754222/?type=3
    For the application fit the "human substitute" view, a chatbot called "Dr Care
    helper" from Hong Kong is for users to make an appointment with a medical
